...
namespace eShopSolutionV1.Data.Migrations
{
    public partial class SeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "DateCreated", "OriginalPrice", "Price", "ProductCategoryId" },
                values: new object[] { 1, new DateTime(2023, 2, 21, 20, 2, 30, 66, DateTimeKind.Local).AddTicks(4405), 100000m, 200000m, 1 });
        }
